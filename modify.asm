section .data
    filename db 'hello', 0
    octet_position equ 456 ;obtenu en effectuant un chagement manuel et en comparant les octets avec une copue de hello avec la commande cmp hello hello_copy
    flags_position equ 460  ;il s'agit de la position de octet_position auquel on ajoute 4  qui correspond à la postion dep_flags 
